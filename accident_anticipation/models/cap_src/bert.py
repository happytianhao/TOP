...
def get_default_args():
    """
    Define and return default arguments for the model.
    This function encapsulates argument parsing to avoid conflicts with other scripts.
    """
    ...
    parser.add_argument('-image_output_type', type=str, default='all',
    ...
    parser.add_argument('-text_length_dynamic', type=int, default=1, help='1: Dynamic length; 0: fixed length')
    parser.add_argument('-fuse_type', type=str, default='att', help='att, ave, max')
    parser.add_argument('-tran_dim', type=int, default=120,
                       help='Input dimension of text and picture encoded transformer')
    parser.add_argument('-tran_num_layers', type=int, default=3, help='The layer of transformer')
    parser.add_argument('-image_num_layers', type=int, default=3, help='The layer of image transformer')
    parser.add_argument('-l_dropout', type=float, default=0.1,
                       help='classify linear dropout')

    # 布尔类型的参数
    parser.add_argument('-fixed_image_model', action='store_true', default=False, help='是否固定图像模型的参数')
    parser.add_argument('-adim', type=int, default=512,
                       help='')
    parser.add_argument('-heads', type=int, default=8,
                       help='the number heads of attention')
    parser.add_argument('-num_tokens', type=int, default=49,
                       help='the number of image tokens')
    parser.add_argument('-c_dim', type=int, default=512,
                       help='')
    parser.add_argument('-s_dim1', type=int, default=120,
                       help='')
    parser.add_argument('-s_dim2', type=int, default=512,
                       help='')
    parser.add_argument('-keral', type=list, default=[3,4],
                       help='')
    ...
    # Return default arguments without parsing
...
class TextModel(nn.Module):
    def __init__(self, opt):
        ...
        abl_path = os.path.join(current_dir, 'bert') + os.sep
